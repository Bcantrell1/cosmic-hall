            ...
            <div className="bg-white w-full h-full rounded-[0.5rem] transition-colors duration-1000 flex flex-col">
                ...
                <div className="p-4 flex flex-col flex-1">
                    <div className="min-h-[3.5rem] mb-2">
                        <h3 className="text-xl font-bold text-indigo-500 line-clamp-2">{title}</h3>
                    </div>
